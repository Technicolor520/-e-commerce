...
public class ContentController {
	 ...
	 */
	@RequestMapping("/add")
	public ResultMessage add(@RequestBody TbContent content){
		try {
	...
	public ResultMessage update(@RequestBody TbContent content){
		try {
	...
	public PageResult query(@RequestBody TbContent content, int pageNum, int pageSize  ){
